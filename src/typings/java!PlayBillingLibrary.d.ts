    ...
    export module billingclient {
      export module api {
        export abstract class BillingClient {
          ...
          public loadRewardedSku(
            param0: com.android.billingclient.api.RewardLoadParams,
            param1: com.android.billingclient.api.RewardResponseListener,
          ): void;
      ...
      export module api {
        ...
        export module BillingFlowParams {
          export class Builder {
            ...
            public setOldSkus(
              param0: java.util.ArrayList<string>,
    ...
    export module billingclient {
      export module api {
        export class ConsumeResponseListener {
           ...
           */
          public constructor(implementation: { onConsumeResponse(param0: number, param1: string): void });
          public constructor();
    ...
    export module billingclient {
      export module api {
        export class PriceChangeConfirmationListener {
           ...
           */
          public constructor(implementation: { onPriceChangeConfirmationResult(param0: number): void });
          public constructor();
    ...
    export module billingclient {
      export module api {
        export class RewardResponseListener {
           ...
           */
          public constructor(implementation: { onRewardResponse(param0: number): void });
          public constructor();
    ...
    export module billingclient {
      export module util {
        export class BillingHelper {
          ...
          public static extractPurchases(
            param0: globalAndroid.os.Bundle,
          ): java.util.List<com.android.billingclient.api.Purchase>;
        }
      }
    }
  }
    ...
    export module vending {
      export module billing {
        export class IInAppBillingService {
          ...
          public getBuyIntentToReplaceSkus(
            param0: number,
            param1: string,
            param2: java.util.List<string>,
            param3: string,
          ...
          public getSubscriptionManagementIntent(
            param0: number,
            param1: string,
            param2: string,
            param3: string,
          ...
          public isBillingSupportedExtraParams(
            param0: number,
            param1: string,
            param2: string,
            param3: globalAndroid.os.Bundle,
          ...
          public getBuyIntentExtraParams(
            param0: number,
            param1: string,
            param2: string,
            param3: string,
