        ...
        export namespace vending {
            export namespace billing {
                ...
                export interface IInAppBillingService {
                     ...
                     */
                    isBillingSupported(apiVersion: number,
                                       packageName: string,
                                       type: string): number;
                     ...
                     */
                    getSkuDetails(apiVersion: number,
                                  packageName: string,
                                  type: string,
                     ...
                     */
                    getBuyIntent(apiVersion: number,
                                 packageName: string,
                                 sku: string,
                                 type: string,
                     ...
                     */
                    getPurchases(apiVersion: number,
                                 packageName: string,
                                 type: string,
                     ...
                     */
                    consumePurchase(apiVersion: number,
                                    packageName: string,
                                    purchaseToken: string): number;

                    /**
                     * This API is currently under development.
                     */
                    stub(apiVersion: number,
                         packageName: string,
                         type: string): number;
                     ...
                     *                                  was signed with the private key of the developer
                     */
                    getBuyIntentToReplaceSkus(apiVersion: number,
                                              packageName: string,
                                              oldSkus: List<string>,
                                              newSku: string,
                                              type: string,
                     ...
                     */
                    getBuyIntentExtraParams(apiVersion: number,
                                            packageName: string,
                                            sku: string,
                                            type: string,
                     ...
                     *                                      user has more owned skus than the current list.
                     */
                    getPurchaseHistory(apiVersion: number,
                                       packageName: string,
                                       type: string,
                     ...
                     * @return RESULT_OK(0) on success and appropriate response code on failures.
                     */
                    isBillingSupportedExtraParams(apiVersion: number,
                                                  packageName: string,
                                                  type: string,
                                                  extraParams: Bundle): number;
                }
