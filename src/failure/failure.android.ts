    ...
    constructor(errorCode: number) {
        ...
        switch ( errorCode ) {
            case com.android.billingclient.api.BillingClient.BillingResponse.FEATURE_NOT_SUPPORTED: /*-2*/
                ...
                break;
            case com.android.billingclient.api.BillingClient.BillingResponse.SERVICE_DISCONNECTED: /*-1*/
                this._type = FailureTypes.BILLING_AVAILABILITY;
                this._description = 'Play Store service is not connected now - potentially transient state.';
                break;
            case com.android.billingclient.api.BillingClient.BillingResponse.OK: /*0*/
                this._type = null;
                this._description = 'Success. Not an error.';
                break;
            case com.android.billingclient.api.BillingClient.BillingResponse.USER_CANCELED: /*1*/
                this._type = FailureTypes.USER_CANCELLED;
                this._description = 'User pressed back or canceled a dialog.';
                break;
            case com.android.billingclient.api.BillingClient.BillingResponse.SERVICE_UNAVAILABLE: /*2*/
                this._type = FailureTypes.BILLING_AVAILABILITY;
                this._description = 'Network connection is down.';
                break;
            case com.android.billingclient.api.BillingClient.BillingResponse.BILLING_UNAVAILABLE: /*3*/
                this._type = FailureTypes.BILLING_AVAILABILITY;
                this._description = 'Billing API version is not supported for the type requested.';
                break;
            case com.android.billingclient.api.BillingClient.BillingResponse.ITEM_UNAVAILABLE: /*4*/
                this._type = FailureTypes.PRODUCT_UNAVAILABLE;
                this._description = 'Requested product is not available for purchase.';
                break;
            case com.android.billingclient.api.BillingClient.BillingResponse.DEVELOPER_ERROR: /*5*/
                this._type = FailureTypes.DEVELOPER_USAGE;
                this._description = 'Invalid arguments provided to the API.';
                break;
            case com.android.billingclient.api.BillingClient.BillingResponse.ERROR: /*6*/
                this._type = FailureTypes.UNSPECIFIED;
                this._description = 'Fatal error during the API action.';
                break;
            case com.android.billingclient.api.BillingClient.BillingResponse.ITEM_ALREADY_OWNED: /*7*/
                this._type = FailureTypes.PRODUCT_ALREADY_OWNED;
                this._description = 'Failure to purchase since item is already owned.';
                break;
            case com.android.billingclient.api.BillingClient.BillingResponse.ITEM_NOT_OWNED:  /*8*/
